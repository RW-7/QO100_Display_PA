...
constexpr uint8_t CIV_C_VFO_READ[] 		= {1,0x04};               	// read Modulation Mode in use
constexpr uint8_t CIV_C_selVFO_READ[]            = {2,0x25,0x00};                 // read frequency VFO A
constexpr uint8_t CIV_C_unSelVFO_READ[]       = {2,0x25,0x01};                 // read frequency VFO B
constexpr uint8_t CIV_C_RF_POW[]      = {2,0x14,0x0A};            // send / read max RF power setting (0..255 == 0 .. 100%)
constexpr uint8_t CIV_D_Splitt_ON[]		  = {2,0x0F,0x01};// set splitt on
constexpr uint8_t CIV_D_Splitt_OFF[]		  = {2,0x0F,0x00};// set splitt on
constexpr uint8_t CIV_C_TRX_ON_OFF[]  = {1,0x18};                 // switch radio ON/OFF
//constexpr uint8_t CIV_SET_SPLIT[]    =   {2,0x1A,0x05}; // + 0x20 0x20 0x04 0x27 for 27.4.2020
constexpr uint8_t CIV_SET_SPLIT[]    =   {2,0x0F,0x01}; // + 0x20 0x20 0x04 0x27 for 27.4.2020
...
constexpr uint8_t CIV_RADIO_ON[]         = {2,0x18, 0x01};        // OFF
